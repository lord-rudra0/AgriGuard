...
const Avatar = ({ name, src, size = 40, online = false, className = '' }) => {
  return (
    <div className={`relative inline-flex items-center justify-center rounded-full bg-gradient-to-br from-primary-500 to-indigo-600 text-white font-bold select-none shadow-sm ring-2 ring-white dark:ring-white/10 ${className}`}
